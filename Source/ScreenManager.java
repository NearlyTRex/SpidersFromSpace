...
public class ScreenManager
{
	...
	// call update() to show any graphics drawn.  The application must dispose of the graphics object.
	...
	// Returns the width of the window currently used in full screen mode. Returns 0 if the device is not in full
	// screen mode.
	public int getWidth()
	{
		Window window = device.getFullScreenWindow();
